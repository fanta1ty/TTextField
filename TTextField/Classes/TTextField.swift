...
private extension TTextField {
    ...
    enum Const {
        ...
        // MARK: - Image
        static let errorImage = UIImage(named: "danger_triangle",
                                        in: bundle,
                                        compatibleWith: nil)!
...
public class TTextField: UITextField {
        ...
        didSet {
            if let message = errorMessage {
                ...
                if errorMessageLabel == nil {
                    ...
                    self.errorMessageLabel = tempLb
                    self.errorImageView = tempImageView
                }
    ...
    override public func layoutSubviews() {
        ...
        if contentOptions.contains(.errorMessageLabel),
...
extension TTextField {
    public func applyErrorUnderlineStyle() {
        underlineView?.backgroundColor = underlineErrorColor
    }
    
    public func applyNonErrorUnderlineStyle() {
...
extension TTextField {
    ...
    private func titleLabelRectForBounds(_ bounds: CGRect) -> CGRect {
        ...
        return CGRect(x: inputRectLeftInset,
                      y: 0,
    ...
    private func boundingRect(for text: String,
                              with font: UIFont,
                              containerBounds bounds: CGRect) -> CGRect {
        let textAttributes = [NSAttributedString.Key.font: font]
        let constraint = CGSize(width: bounds.size.width,
                                height: .greatestFiniteMagnitude)
        
        let boundingRect = text.boundingRect(with: constraint,
    ...
    private func inputRect(forBounds bounds: CGRect) -> CGRect {
        ...
        var rect = CGRect(x: inputRectLeftInset,
                          y: inputTopSpacing(),
    ...
    private func errorLabelRectForBounds(_ bounds: CGRect) -> CGRect {
        ...
        let containerBounds = CGRect(origin: bounds.origin,
                                     size: CGSize(width: bounds.width - imageWidth,
                                                  height: bounds.height))
        
        let boundingRect = boundingRect(for: message,
                                        with: font,
                                        containerBounds: containerBounds)
        
        return CGRect(x: imageWidth,
